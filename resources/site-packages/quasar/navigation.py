...
def run(url_suffix=""):
    if not os.path.exists(os.path.join(xbmc.translatePath(ADDON_PATH), ".firstrun")):
        notify(getLocalizedString(30101))
        system_information()
        return

    donatePath = os.path.join(xbmc.translatePath(ADDON_PATH), ".donate")
    ...
    for i, item in enumerate(data["items"]):
        ...
        if item.get("art"):
            ...
            fanart = os.path.join(xbmc.translatePath(ADDON_PATH), "fanart.jpg")
